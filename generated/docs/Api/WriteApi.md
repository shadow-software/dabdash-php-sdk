...
try {
    ...
    echo 'Exception when calling WriteApi->campaignFlyerStylePack: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling WriteApi->campaignGenerateFlyer: ', $e->getMessage(), PHP_EOL;
}
```
