 ...
 */
class ProductInspectResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProductInspectResponse';
    ...
    protected static $attributeMap = [
        'tenant' => 'tenant',
        'mix_match_settings' => 'mix_match_settings',
        'products' => 'products'
    ];
    ...
    protected static $setters = [
        'tenant' => 'setTenant',
        'mix_match_settings' => 'setMixMatchSettings',
    ...
    protected static $getters = [
        'tenant' => 'getTenant',
        'mix_match_settings' => 'getMixMatchSettings',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mix_match_settings', $data ?? [], null);
    ...
    {
        return $this->container['mix_match_settings'];
    }
     ...
     * @return self
     */
    public function setMixMatchSettings($mix_match_settings)
    {
        if (is_null($mix_match_settings)) {
            throw new \InvalidArgumentException('non-nullable mix_match_settings cannot be null');
        }
        $this->container['mix_match_settings'] = $mix_match_settings;
