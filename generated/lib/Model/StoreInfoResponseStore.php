...
/**
 * StoreInfoResponseStore Class Doc Comment
 *
 * @category Class
 * @package  ShadowSoftware\Sdk\Generated
 * @author   OpenAPI Generator team
 ...
 */
class StoreInfoResponseStore implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'StoreInfoResponse_store';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('has_active_subscription', $data ?? [], null);
    }
     ...
     * Sets on_trial
     *
     * @param bool|null $on_trial on_trial
     *
     * @return self
     */
     ...
     *
     * @param bool|null $has_active_subscription has_active_subscription
     *
     * @return self
     */
    public function setHasActiveSubscription($has_active_subscription)
    {
        if (is_null($has_active_subscription)) {
            throw new \InvalidArgumentException('non-nullable has_active_subscription cannot be null');
        }
