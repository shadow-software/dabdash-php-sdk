...
/**
 * ProductFeatureManageRequest Class Doc Comment
 *
 * @category Class
 * @package  ShadowSoftware\DabDash
 * @author   OpenAPI Generator team
 ...
 */
class ProductFeatureManageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProductFeatureManageRequest';
     ...
     * Sets action
     *
     * @param string|null $action \"list\" (default) or \"set\".
     *
     * @return self
     */
     ...
     * Sets product_ids
     *
     * @param int[]|null $product_ids Product ids to update. Required for action=set.
     *
     * @return self
     */
     ...
     * Sets featured
     *
     * @param bool|null $featured Value to set is_featured to for product_ids. Required for action=set.
     *
     * @return self
     */
