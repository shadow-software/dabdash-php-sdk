<?php
/**
 * MetrcDiagnosticsResponseIntegrationAnyOf1
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * MetrcDiagnosticsResponseIntegrationAnyOf1 Class Doc Comment
 *
 * @category Class
 * @package  ShadowSoftware\DabDash
 * @author   OpenAPI Generator team
 ...
 */
class MetrcDiagnosticsResponseIntegrationAnyOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MetrcDiagnosticsResponse_integration_anyOf_1';
    ...
    public function setLastErrorAt($last_error_at)
    {
        if (is_null($last_error_at)) {
            array_push($this->openAPINullablesSetToNull, 'last_error_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_error_at', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
