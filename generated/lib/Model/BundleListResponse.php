 ...
 */
class BundleListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BundleListResponse';
    ...
    protected static $attributeMap = [
        'tenant' => 'tenant',
        'summary' => 'summary',
        'zero_discount_bundles' => 'zero_discount_bundles',
        'bundles' => 'bundles'
    ];
    ...
    protected static $setters = [
        'tenant' => 'setTenant',
        'summary' => 'setSummary',
        'zero_discount_bundles' => 'setZeroDiscountBundles',
        'bundles' => 'setBundles'
    ];
    ...
    protected static $getters = [
        'tenant' => 'getTenant',
        'summary' => 'getSummary',
        'zero_discount_bundles' => 'getZeroDiscountBundles',
        'bundles' => 'getBundles'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('zero_discount_bundles', $data ?? [], null);
    ...
    /**
     * Gets zero_discount_bundles
     *
     * @return string[]|null
     */
    public function getZeroDiscountBundles()
    {
        return $this->container['zero_discount_bundles'];
    }

    /**
     * Sets zero_discount_bundles
     *
     * @param string[]|null $zero_discount_bundles zero_discount_bundles
     *
     * @return self
     */
    public function setZeroDiscountBundles($zero_discount_bundles)
    {
        if (is_null($zero_discount_bundles)) {
            throw new \InvalidArgumentException('non-nullable zero_discount_bundles cannot be null');
        }
        $this->container['zero_discount_bundles'] = $zero_discount_bundles;
