<?php
/**
 * CustomerConversationContextResponseConversationsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CustomerConversationContextResponseConversationsInner Class Doc Comment
 *
 * @category Class
 * @package  ShadowSoftware\DabDash
 * @author   OpenAPI Generator team
 ...
 */
class CustomerConversationContextResponseConversationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CustomerConversationContextResponse_conversations_inner';
    ...
    protected static $setters = [
        ...
        'subject' => 'setSubject',
        'last_customer_message' => 'setLastCustomerMessage',
    ...
    protected static $getters = [
        ...
        'subject' => 'getSubject',
        'last_customer_message' => 'getLastCustomerMessage',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('last_customer_message', $data ?? [], null);
    ...
    /**
     * Gets last_customer_message
     *
     * @return string|null
     */
    public function getLastCustomerMessage()
    {
        return $this->container['last_customer_message'];
    }

    /**
     * Sets last_customer_message
     *
     * @param string|null $last_customer_message last_customer_message
     *
     * @return self
     */
    public function setLastCustomerMessage($last_customer_message)
    {
        if (is_null($last_customer_message)) {
            throw new \InvalidArgumentException('non-nullable last_customer_message cannot be null');
        }
        $this->container['last_customer_message'] = $last_customer_message;
     ...
     *
     * @param string|null $last_message_at last_message_at
     *
     * @return self
     */
