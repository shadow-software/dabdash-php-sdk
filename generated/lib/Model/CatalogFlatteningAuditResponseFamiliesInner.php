 ...
 */
class CatalogFlatteningAuditResponseFamiliesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CatalogFlatteningAuditResponse_families_inner';
     ...
     * Sets collapsible
     *
     * @param bool|null $collapsible collapsible
     *
     * @return self
     */
     ...
     * Sets blocker
     *
     * @param string|null $blocker blocker
     *
     * @return self
     */
    ...
    {
        if (is_null($blocker)) {
            array_push($this->openAPINullablesSetToNull, 'blocker');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('blocker', $nullablesSetToNull);
            if ($index !== FALSE) {
