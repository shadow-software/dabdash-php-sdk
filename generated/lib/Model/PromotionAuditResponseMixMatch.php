<?php
/**
 * PromotionAuditResponseMixMatch
 *
 * PHP version 8.1
 *
 * @category Class
 ...
 */
class PromotionAuditResponseMixMatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PromotionAuditResponse_mix_match';
    ...
    protected static $attributeMap = [
        'note' => 'note',
        'rules' => 'rules',
        'tagged_variations' => 'tagged_variations'
    ];
    ...
    protected static $setters = [
        'note' => 'setNote',
        'rules' => 'setRules',
        'tagged_variations' => 'setTaggedVariations'
    ];
    ...
    protected static $getters = [
        'note' => 'getNote',
        'rules' => 'getRules',
        'tagged_variations' => 'getTaggedVariations'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tagged_variations', $data ?? [], null);
    }
    ...
    {
        return $this->container['tagged_variations'];
    }
     ...
     * @return self
     */
    public function setTaggedVariations($tagged_variations)
    {
        if (is_null($tagged_variations)) {
            throw new \InvalidArgumentException('non-nullable tagged_variations cannot be null');
        }
        $this->container['tagged_variations'] = $tagged_variations;
